          ...
          <div class="container relative w-full px-8 pt-16 mx-auto lg:px-4 z-[5]">
            <div class="flex flex-col w-full mb-12 text-center">
              <h1 class="mb-2 text-6xl font-bold tracking-tighter lg:text-8xl">
                <span class="bg-gradient-to-br from-blue-500 to-blue-300 bg-clip-text text-transparent font-bold">JS</span>
                <span class="ml-2 bg-gradient-to-bl from-base-content to-base-content/80 bg-clip-text text-transparent font-bold">الشتاء</span>
              </h1>
